...
export const BaseFlowPathSegment : React.FC<FlowPathSegmentProps> = (props) => {
    ...
    return (
        <g 
            ...
            <path d={d} style={{ stroke: '#eee' }} className={"flow-path__pipe-border"}  />
            <path d={d} style={{stroke: '#ddd' }} className={"flow-path__pipe"}  />
            <path d={d} style={{stroke: '#ddd' }} className={"flow-path"} {...{"marker-end": "url(#head)"}} />
